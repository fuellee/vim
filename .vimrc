" to do:
" merge filetype.vim to this (initialization order sucks)
...
" `filetype on` causes reload of .vim/filetype.vim & .vim/after/filetype.vim
" }}}
...
" set list " list mode, show unprintable chars as set above
...
set undodir=$HOME/.vim/undo/         " Save undo data
set backupdir=/tmp                          " keep backup files in /tmp
set dir=/tmp                                " keep swap files in /tmp
set viewdir=$HOME/.vim/view          " save views "
...
" let g:syntastic_javascript_checker = 'jshint' " default
...
autocmd Syntax vim,help setlocal keywordprg=:help foldmethod=marker


" bash
autocmd Syntax sh setlocal keywordprg=:Man foldmethod=marker
...
" Matlab/Octave
autocmd! BufRead,BufNewFile *.m,*.oct set filetype=matlab "octave
